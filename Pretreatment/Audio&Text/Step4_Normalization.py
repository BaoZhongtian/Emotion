...
if __name__ == '__main__':
    ...
    for part in ['improve', 'script']:
        for gender in ['Female', 'Male']:
            loadpath = 'D:/PythonProjects_Data/IEMOCAP_Text&Audio/Step3_SpectrumGeneration/%s/%s/' % (part, gender)
            savepath = 'D:/PythonProjects_Data/IEMOCAP_Text&Audio/Step4_Normalization/%s/%s/' % (part, gender)
