...
if __name__ == '__main__':
    ...
    for part in ['improve', 'script']:
        for gender in ['Female', 'Male']:
            loadpath = 'D:/PythonProjects_Data/IEMOCAP/IEMOCAP-Voices-Choosed/%s/%s/' % (part, gender)
            savepath = 'D:/PythonProjects_Data/IEMOCAP/Step1_SpectrumGeneration/%s/%s/' % (part, gender)
